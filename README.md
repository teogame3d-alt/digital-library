...
The image is a portfolio overview generated from the real OOP model. The application itself remains
a CLI project, which keeps the focus on domain modeling, state transitions, persistence, and tests.
